...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Revature Employee Vessel';
    }
...
var ApplicationService = /** @class */ (function () {
    function ApplicationService(http, messageService) {
        ...
        this.url = 'http://localhost:8080/REVjava/application';
    }
    /** POST: send credentials to server */
    ApplicationService.prototype.postUser = function (user) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _application_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../application.service */ "./src/app/application.service.ts");
...
var ApplicationComponent = /** @class */ (function () {
    ...
    ApplicationComponent.prototype.postApplication = function () {
        console.log(this.first + ' ' + this.last);
        var u = new _user__WEBPACK_IMPORTED_MODULE_2__["User"](this.first, this.last, this.email, this.pass, this.city, this.state, this.client, this.batch, this.position);
        console.log(u);
...
var Credentials = /** @class */ (function () {
    function Credentials(email, pass) {
        this.email = email,
            this.pass = pass;
    }
    return Credentials;
...
var LoginService = /** @class */ (function () {
    function LoginService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.url = 'http://localhost:8080/REVjava/login';
    }
    /** POST: send credentials to server */
    LoginService.prototype.postLogin = function (credentials) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.postCredentials = function () {
        console.log(this.email + ' ' + this.pass);
        var c = new _credentials__WEBPACK_IMPORTED_MODULE_2__["Credentials"](this.email, this.pass);
        console.log(c);
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(messageSeervice) {
        this.messageSeervice = messageSeervice;
    }
...
var User = /** @class */ (function () {
    function User(first, last, email, pass, city, state, client, batch, pos) {
...
module.exports = __webpack_require__(/*! C:\Users\Juan Carlos\Dropbox\Revature\REVangular\angular-rev\src\main.ts */"./src/main.ts");
